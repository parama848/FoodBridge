...
public class Notification {
    ...
    protected void onCreate() {
        ...
        /*
         * FoodBridge currently uses LocalDateTime.
         *
         * LocalDateTime has NO timezone information.
         *
         * Therefore we explicitly generate the timestamp
         * using India Standard Time so that the value stored
         * in the database matches the timezone expected by
         * the frontend.
         */
